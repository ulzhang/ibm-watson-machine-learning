...
from ibm_watson_machine_learning.foundation_models.utils.utils import get_model_specs, _check_if_constricted
...
class FMModelInference(BaseModelInference):
    ...
    def __init__(self,
        ...
        _check_if_constricted(self._client.wml_credentials.get('url'), self.model_id)
