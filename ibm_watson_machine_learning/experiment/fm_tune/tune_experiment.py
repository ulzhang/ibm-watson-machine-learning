...
from ibm_watson_machine_learning.foundation_models.utils.enums import PromptTuningTypes, PromptTuningInitMethods, \
    TuneExperimentTasks
from ibm_watson_machine_learning.foundation_models.utils.utils import get_model_specs_with_prompt_tuning_support, _check_if_constricted
    ...
    **Example**
    ...
    def prompt_tuner(self,
        ...
        **Examples**
        ...
        _check_if_constricted(self.client.wml_credentials.get('url'), base_model)
