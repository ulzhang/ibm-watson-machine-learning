...
class AutoPipelinesRuns(BaseAutoPipelinesRuns):
        ...
        **Example**
        ...
        if run_id is None:
            optimizer_id = self._wml_engine._wml_client.training.get_details(
                limit=1, tag_value='autoai', _internal=True
    ...
    def get_run_details(self, run_id: str = None) -> dict:
        ...
        **Example**
        ...
        """
        if run_id is None:
            details = self._wml_engine._wml_client.training.get_details(limit=1, tag_value='autoai', _internal=True).get('resources')[0]
