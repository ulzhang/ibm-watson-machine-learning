    ...
    def _initialize_wml_pipeline_metadata(self, **kwargs) -> None:
        ...
        if ((self._wml_client.CLOUD_PLATFORM_SPACES or self._wml_client.CPD_version) and
            ...
            if self._wml_client.CLOUD_PLATFORM_SPACES or self._wml_client.CPD_version >= 4.8:
                ...
                if self._auto_pipelines_parameters.get('feature_selector_auto_delta') is not None:
                    self._wml_pipeline_metadata[self._wml_client.pipelines.ConfigurationMetaNames.DOCUMENT][
                        'pipelines'][0]['nodes'][0]['parameters']['optimization'][
                        'feature_selector_auto_delta'] = self._auto_pipelines_parameters.get('feature_selector_auto_delta')
        # end note
