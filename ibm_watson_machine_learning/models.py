...
from ibm_watson_machine_learning.utils.autoai.utils import download_request_json
import os
import copy
import urllib.parse
import time
...
class Models(WMLResource):
    ...
    def store(self, model=None, meta_props=None, training_data=None, training_target=None, pipeline=None, version=False,
        ...
        **Examples**
        ...
        try:
            from ibm_watsonx_ai.foundation_models.utils.utils import is_training_prompt_tuning
        except ModuleNotFoundError:
            from ibm_watson_machine_learning.foundation_models.utils.utils import is_training_prompt_tuning
        ...
        if training_id and is_training_prompt_tuning(training_id, self._client):
            ...
            try:
                ...
                from ibm_watson_machine_learning.foundation_models.utils.utils import load_request_json
